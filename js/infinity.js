addLayer("in", {
        ...
        stuff: {
            ...
            "Pylon": {
                ...
                content: [
                    ...
                    ["blank", "25px"],
                    ["clickable", 11],
                    ["raw-html", () => { return player.in.pylonBuilt ? "你有 <h3>" + format(player.in.pylonEnergy) + "/" + format(player.in.pylonEnergyMax) +  "</h3> paradox pylon energy (" + format(player.in.pylonEnergyPerSecond) + "/秒）." : "" }, {color: "#000000ff", fontSize: "24px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.in.pylonBuilt ? "提升 U2 tickspeed x" + format(player.in.pylonEnergyEffect) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.in.pylonBuilt ? "提升 infinities x" + format(player.in.pylonEnergyEffect2) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.in.pylonBuilt ? "提升 ancient pylon energy x" + format(player.in.pylonEnergyEffect3) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
    ...
    tabFormat: [
        ...
        ["raw-html", () => {return "提升点数 x" + format(player.ad.antimatterEffect) + " (based on points and antimatter)"}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
