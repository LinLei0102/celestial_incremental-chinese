addLayer("p", {
    ...
    clickables: {
        ...
        11: {
            title() { return "<h2>威望重置，重置所有等级和因子。</h2><br><h3>需求：100,000 天体点数</h3>" },
    ...
    upgrades: {
        11: {
            title: "威望升级I",
            unlocked() { return true },
            description: "三倍天体点数获得。",
            cost: new Decimal(1),
            currencyLocation() { return player.p },
            currencyDisplayName: "威望点数",
        ...
        15: {
            title: "威望升级VI",
            unlocked() { return true },
            description: "自动购买因子I-VIII。",
            cost: new Decimal(64),
            currencyLocation() { return player.p },
            currencyDisplayName: "威望点数",
            currencyInternalName: "prestigePoints",
            tooltip() { return "自动购买器不消耗资源。这适用于游戏中大多数自动购买器。" },
            style: {color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"},
        },
        16: {
            title: "威望升级VII",
            unlocked() { return hasUpgrade("i", 15) },
            description: "解锁第二个增强因子力量的四阶效果。",
        ...
        19: {
            ...
            description: "解锁力量因子VIII和更多树木可购买项。",
        ...
        stuff: {
            ...
            "Crystallize": {
                ...
                content: [
                    ...
                    ["row", [
                        ["raw-html", () => {return "提升等级、阶位、四阶和五阶效果 <h3>^" + format(player.p.crystalEffect, 5) + "</h3>."}, {color: "#b6658c", fontSize: "16px", fontFamily: "monospace"}],
    ...
    tabFormat: [
        ...
        ["row", [
            ["raw-html", () => { return "你有 <h3>" + format(player.p.prestigePoints) + "</h3> 威望点数." }, {color: "#31aeb0", fontSize: "24px", fontFamily: "monospace"}],
        ...
        ["row", [
            ["raw-html", () => {return hasUpgrade("p", 12) ? "提升天体点数 x" + format(player.p.prestigeEffect) : ""}, {color: "#31aeb0", fontSize: "20px", fontFamily: "monospace"}],
        ...
        ["row", [
            ["raw-html", () => {return hasUpgrade("g", 11) ? "提升 grass value x" + format(player.p.prestigeEffect2) : ""}, {color: "#31aeb0", fontSize: "20px", fontFamily: "monospace"}],
