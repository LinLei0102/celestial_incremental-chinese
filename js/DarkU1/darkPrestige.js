        ...
        stuff: {
            "Main": {
                ...
                content: [
                    ["blank", "25px"],
                    ["row", [
                        ["raw-html", () => {return "你有 <h3>" + format(player.dp.prestigePoints) + "</h3> prestige points"}, {color: "white", fontSize: "24px", fontFamily: "monospace"}],
                    ...
                    ["raw-html", () => {return "提升 rank, tier, and tetr point gain by x" + format(player.dp.prestigePointsEffect)}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "25px"],
                    ["row", [["clickable", 11]]],
                    ["blank", "25px"],
