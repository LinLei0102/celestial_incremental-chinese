        ...
        stuff: {
            ...
            "Studies": {
                ...
                content: [
                    ...
                    ["raw-html", function () { return "提升 grass value x" + format(player.gh.fertilizerEffect) + "." }, {color: "#EFD4B9", fontSize: "16px", fontFamily: "monospace"}],
                    ["blank", "10px"],
            ...
            "Steelie": {
                ...
                content: [
                    ...
                    ["raw-html", () => { return "提升 grasshopper gain x" + format(player.gh.steelEffect)}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "25px"],
                    ["row", [["clickable", 12]]],
                    ["blank", "25px"],
