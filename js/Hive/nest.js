        ...
        Tabs: {
            "Upgrades": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return "提升 pollinators by x" + formatSimple(player.n.nestEffect)}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "10px"],
                    ["clickable", 1],
                    ["blank", "10px"],
                    ["upgrade", 11],
            ...
            "Pylon": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return "提升 UB tickspeed by x" + format(player.n.pylonEnergyEffect) + "."}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return "提升 glossary effect base by x" + format(player.n.pylonEnergyEffect2) + "."}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return "提升 temporal pylon energy by x" + format(player.n.pylonEnergyEffect3) + "."}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
