        ...
        Tabs: {
            "Upgrades": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return "提升 pollinators x" + formatSimple(player.n.nestEffect)}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "10px"],
                    ["clickable", 1],
                    ["blank", "10px"],
                    ["upgrade", 11],
            ...
            "Pylon": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return "提升 UB tickspeed x" + format(player.n.pylonEnergyEffect) + "."}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return "提升 glossary effect base x" + format(player.n.pylonEnergyEffect2) + "."}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return "提升 temporal pylon energy x" + format(player.n.pylonEnergyEffect3) + "."}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
