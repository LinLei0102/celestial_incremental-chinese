        ...
        ["row", [
            ["style-column", [
                ["style-column", [
                    ...
                    ["row", [
                        ["raw-html", () => {return "提升 BPS x" + formatSimple(player.ne.alpha.effect, 2)}, {color: "#161616", fontSize: "14px", fontFamily: "monospace"}],
            ...
            ["style-column", [
                ["style-column", [
                    ...
                    ["raw-html", () => {return "提升 flower gain x" + formatSimple(player.ne.beta.effect, 2)}, {color: "#161616", fontSize: "14px", fontFamily: "monospace"}],
                    ["blank", "10px"],
                    ["clickable", 2],
                ], {width: "400px", height: "147px", borderBottom: "3px solid #6d3701"}],
                ["style-row", [
            ...
            ["style-column", [
                ["style-column", [
                    ...
                    ["raw-html", () => {return "提升 nectar gain x" + formatSimple(player.ne.delta.effect, 2)}, {color: "#161616", fontSize: "14px", fontFamily: "monospace"}],
                    ["blank", "10px"],
                    ["clickable", 4],
                ], {width: "400px", height: "147px", borderBottom: "3px solid #6d3701"}],
                ["style-row", [
            ...
            ["style-column", [
                ["style-column", [
                    ...
                    ["raw-html", () => {return "提升 pollen gain x" + formatSimple(player.ne.epsilon.effect, 2)}, {color: "#161616", fontSize: "14px", fontFamily: "monospace"}],
                    ["blank", "10px"],
                    ["clickable", 5],
