        ...
        ["style-row", [
            ["theme-scroll-column", [
                ...
                ["style-column", [
                    ...
                    ["raw-html", () => {return "提升 matos dust gain x" + formatSimple(player.laboratory.matosFragment.add(1).log(10).add(1))}, {color: "var(--textColor)", fontSize: "16px", fontFamily: "monospace"}],
                ...
                ["style-column", [
                    ...
                    ["raw-html", () => {return "提升 matos shard gain x" + formatSimple(player.laboratory.matosEssence.add(1).log(10).add(1))}, {color: "var(--textColor)", fontSize: "16px", fontFamily: "monospace"}],
