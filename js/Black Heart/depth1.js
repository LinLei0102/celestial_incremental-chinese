            ...
            "positive": {
                ...
                content: [
                    ["style-row", [
                        ["style-column", [
                            ["style-column", [
                                ["raw-html", () => {return "你有 " + formatShortWhole(player.depth1.gloomingUmbrite) + " glooming umbrite."}, {color: "var(--textColor)", fontSize: "14px", fontFamily: "monospace"}],
                                ["raw-html", () => {return "你有 " + formatShortWhole(player.depth1.dimUmbrite) + " dim umbrite."}, {color: "var(--textColor)", fontSize: "14px", fontFamily: "monospace"}],
                        ...
                        ["style-column", [
                            ["top-column", [
                                ...
                                ["top-column", [
                                    ["raw-html", () => {return "提升无限点数 x" + formatSimple(player.depth1.comboEffect)}, {color: "var(--textColor)", fontSize: "11px", fontFamily: "monospace"}],
                    ...
                    ["style-row", [
                        ...
                        ["style-column", [
                            ["top-column", [
                                ...
                                ["top-column", [
                                    ["raw-html", () => {return "提升 base IP gain ^" + formatSimple(player.depth1.negComboEffect)}, {color: "var(--textColor)", fontSize: "11px", fontFamily: "monospace"}],
                                ], {width: "272px", height: "25px"}],
                                ["top-column", [
                                    ["blank", "4px"],
                                    ["raw-html", () => {return "Milestones increase skill points by +" + formatSimple(player.depth1.milestoneEffect)}, {color: "var(--textColor)", fontSize: "11px", fontFamily: "monospace"}],
