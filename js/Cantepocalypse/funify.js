        ...
        stuff: {
            "Main": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return "提升 oil x" + format(player.fu.funEffect)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
                    ["raw-html", () => {return "提升 proto memories x" + format(player.fu.funEffect2)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
                    ["blank", "25px"],
                    ["row", [["clickable", 11]]],
                    ["blank", "25px"],
            ...
            "Fear": {
                ...
                content: [
                    ...
                    ["raw-html", () => { return inChallenge("fu", 11) ? "提升 anonymity gain x" + format(player.fu.jocusEssenceEffect) : player.fu.enterFear ? "Effect only active in Fear Challenge" : "" }, () => {
        ...
        mood: {
            "Happiness": {
                content: [
                    ...
                    ["raw-html", () => { return "提升 steel gain x" + format(player.fu.happinessEffect2)}, {color: "#fcff04", fontSize: "20px", fontFamily: "monospace"}],
            ...
            "Sadness": {
                content: [
                    ...
                    ["raw-html", () => { return "提升 infinity points gain x" + format(player.fu.sadnessEffect2)}, {color: "#110057", fontSize: "20px", fontFamily: "monospace"}],
            ...
            "Anger": {
                content: [
                    ...
                    ["raw-html", () => { return "提升 singularity point gain x" + format(player.fu.angerEffect2)}, {color: "#ff2b3d", fontSize: "20px", fontFamily: "monospace"}],
            ...
            "Fear": {
                content: [
                    ...
                    ["raw-html", () => { return inChallenge("fu", 11) ? "提升 replicanti point mult post softcap x" + format(player.fu.fearEffect2) : "Effect only active in Fear Challenge" }, () => {
                        let look = {fontSize: "20px", fontFamily: "monospace"}
            ...
            "Numbness": {
                content: [
                    ...
                    ["row", [
                        ["raw-html", () => { return inChallenge("fu", 12) ? "提升 anonymity ^" + format(player.fu.numbEffect2) : "Effect only active in Numbness Challenge" }, () => {
                            let look = {fontSize: "20px", fontFamily: "monospace"}
                            if (inChallenge("fu", 12)) {look.color = "white"} else {look.color = "gray"}
                            return look
                        }],
