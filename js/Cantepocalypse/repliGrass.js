addLayer("rg", {
    ...
    tabFormat: [
        ...
        ["raw-html", () => { return "提升 repli-leaf mult x" + format(player.rg.repliGrassEffect) + "." }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
        ["raw-html", () => { return "提升 replicanti point mult x" + format(player.rg.repliGrassEffect2) + "." }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
