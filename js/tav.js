        ...
        stuff: {
            ...
            "OTF Synergizer": {
                ...
                content: [
                    ...
                    ["raw-html", function () { return (player.po.hex || hasUpgrade("s", 18)) ? "你有 <h3>" + format(player.h.hexPoint) + "</h3> hex points. (highest: " + format(player.ta.highestHexPoints) + ")" :""}, { color: "white", fontSize: "20px", fontFamily: "monospace" }],
                    ["raw-html", function () { return (!player.po.hex && !hasUpgrade("s", 18)) ? "你有 <h3><s>" + format(player.h.hexPoint) + "</s></h3> hex points. (highest: " + format(player.ta.highestHexPoints) + ")" : ""}, { color: "white", fontSize: "20px", fontFamily: "monospace" }],
                    ["blank", "25px"],
