addLayer("ad", {
    ...
    upgrades: {
        ...
        13: {
            ...
            unlocked() { return true },
            description: "提升 rank effect（基于 antimatter.",
        ...
        14: {
            ...
            description: "提升 grass（基于 antimatter.",
        ...
        15: {
            title: "AD Upgrade V",
            unlocked() { return player.in.infinities.gte(2) },
            description: "提升 trees and leaves（基于 antimatter.",
        ...
        16: {
            title: "AD Upgrade VI",
            unlocked() { return player.in.infinities.gte(2) },
            description: "提升 grasshoppers and fertilizer（基于 antimatter.",
        ...
        18: {
            ...
            unlocked() { return player.in.infinities.gte(3) },
            description: "提升 mods and lines of code（基于 antimatter.",
        ...
        21: {
            title: "AD Upgrade X",
            unlocked() { return player.in.infinities.gte(3) },
            description: "提升 code experience（基于 antimatter.",
