addLayer("id", {
    ...
    tabFormat: [
        ...
        ["raw-html", () => { return "提升 antimatter dimensions by x" + format(player.id.infinityPowerEffect)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
        ["raw-html", () => { return "提升 points by x" + format(player.id.infinityPowerEffect2)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
