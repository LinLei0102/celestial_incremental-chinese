addLayer("id", {
    ...
    tabFormat: [
        ...
        ["raw-html", () => { return "提升 antimatter dimensions x" + format(player.id.infinityPowerEffect)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
        ["raw-html", () => { return "提升点数 x" + format(player.id.infinityPowerEffect2)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
