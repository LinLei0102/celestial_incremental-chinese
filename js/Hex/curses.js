addLayer("hcu", {
    ...
    universe: "UA",
    tooltip: "诅咒", // Decides the nodes tooltip
    ...
    tabFormat: [
        ...
        ["blank", "10px"],
        ["tooltip-row", [
            ["raw-html", () => {return "你有 <h3>" + format(player.hcu.curses) + "</h3> Curses." }, {color: "white", fontSize: "24px", fontFamily: "monospace"}],
            ["raw-html", () => {return "(+" + format(player.hcu.cursesGain) + "/秒）" }, () => {
