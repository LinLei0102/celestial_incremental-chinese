        ...
        realm: {
            ...
            "Essence": {
                ...
                content: [
                    ...
                    ["style-column", [
                        ["row", [
                            ["raw-html", () => {return "你有 <h3>" + formatShort(player.hrm.realmEssence) + "</h3> Realm Essence."}, {color: "white", fontSize: "24px", fontFamily: "monospace"}],
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 Pre-Power resources x" + format(player.hrm.realmEssenceEffects[0])}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 Checkback Tickspeed x" + format(player.hrm.realmEssenceEffects[1])}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
