addLayer("cbs", {
    ...
    upgrades: {
        11: {
            ...
            unlocked() { return player.cbs.shrineReactivated },
            description: "提升 chance points based on check back level.",
        ...
        12: {
            ...
            unlocked() { return player.cbs.shrineReactivated },
            description: "提升 wheel points based on best chance points.",
         ...
         ["raw-html", function () { return player.cbs.shrineReactivated ? "Check Back Blessings" : "" }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
            ...
            ["tooltip-row", [
                ...
                ["raw-html", "<div class='bottomTooltip'>Temporal Core Fragments<hr>"],
                    ...
                    ["blank", "25px"],
                    ["raw-html", () => {return player.cbs.pylonBuilt ? "提升 CB tickspeed by x" + format(player.cbs.pylonEnergyEffect) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.cbs.pylonBuilt ? "提升 pet points by x" + format(player.cbs.pylonEnergyEffect2) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.cbs.pylonBuilt ? "提升 crate roll chance by x" + format(player.cbs.pylonEnergyEffect3) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.cbs.pylonBuilt ? "提升 paradox pylon energy by ^" + format(player.cbs.pylonEnergyEffect4) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
