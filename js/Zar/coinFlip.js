        ...
        stuff: {
            "Main": {
                ...
                content: [
                    ...
                    ["raw-html", function () { return "提升 chance points x" + format(player.cf.headsEffect) + "." }, { "color": "white", "font-size": "16px", "font-family": "monospace" }],
                    ["raw-html", function () { return "提升 tails gain x" + format(player.cf.headsEffect2) + "." }, { "color": "white", "font-size": "16px", "font-family": "monospace" }],
                    ...
                    ["raw-html", function () { return "提升 heads gain x" + format(player.cf.tailsEffect2) + "." }, { "color": "white", "font-size": "16px", "font-family": "monospace" }],
