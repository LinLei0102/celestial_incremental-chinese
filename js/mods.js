addLayer("m", {
    ...
    tabFormat: [
        ...
        ["raw-html", () => {return hasUpgrade("cs", 701) ? "提升 factor base x" + format(player.m.codeExperienceEffect) : ""}, {color: "#1377BF", fontSize: "20px", fontFamily: "monospace"}],
        ["blank", "15px"],
        ["clickable", 11],
        ["blank", "25px"],
        ["style-column", [
            ...
            ["raw-html", () => {return "提升 tree gain x" + format(player.m.modEffect) + "."}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ["blank", "10px"],
            ["bar", "modbar"],
            ["blank", "10px"],
