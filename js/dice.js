addLayer("d", {
        ...
        stuff: {
            ...
            "Challenge Dice": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return "提升 dice point gain x" + format(player.d.challengeDicePointsEffect)}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return hasUpgrade("cs", 803) ? "提升 dice score x" + format(player.d.challengeDicePointsEffect2) : ""}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "25px"],
                    ["style-row", [
    ...
    tabFormat: [
        ...
        ["raw-html", () => { return "提升 check back level effect ^" + format(player.d.dicePointsEffect) }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
