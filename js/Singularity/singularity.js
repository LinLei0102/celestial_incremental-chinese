        ...
        stuff: {
            ...
            "里程碑": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return hasUpgrade("fu", 19) ? "提升 core scraps x" + format(player.s.singularitiesEffect) : ""}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "25px"],
                    ["milestone", 11],
                    ["milestone", 12],
                    ["milestone", 13],
            ...
            "Pylon": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return player.s.pylonBuilt ? "提升 U3 tickspeed x" + format(player.s.pylonEnergyEffect) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return player.s.pylonBuilt ? "提升 radiation x" + format(player.s.pylonEnergyEffect2) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ...
                    ["raw-html", () => {return player.s.pylonBuilt ? "提升 natural pylon energy x" + format(player.s.pylonEnergyEffect4) + "." : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
