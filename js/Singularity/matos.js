            ...
            "黑心": {
                ...
                content: [
                    ...
                    ["style-column", [
                        ...
                        ["raw-html", () => {return "提升 IP gain x" + format(player.ma.bestComboDepth1Effect)}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                        ["raw-html", () => {return hasMilestone("ma", 102) ? "提升 common matos fragment gain x" + formatShort(player.ma.bestComboDepth1Effect2) : ""}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                        ...
                        ["raw-html", () => {return player.ma.secondAreaUnlock ? "提升 NIP gain x" + format(player.ma.bestComboDepth2Effect) : "" }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                        ["raw-html", () => {return hasMilestone("ma", 202) ? "提升 rare matos fragment gain x" + formatShort(player.ma.bestComboDepth2Effect2) : ""}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                        ...
                        ["raw-html", () => {return hasUpgrade("ma", 27) ? "提升 SP gain x" + format(player.ma.bestComboDepth3Effect) : "" }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                        ["raw-html", () => {return hasMilestone("ma", 302) ? "提升 epic matos fragment gain x" + formatShort(player.ma.bestComboDepth3Effect2) : ""}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
