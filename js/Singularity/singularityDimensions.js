addLayer("sd", {
    ...
    tabFormat: [
        ...
        ["raw-html", () => {return "提升 infinity and negative infinity points x" + format(player.sd.singularityPowerEffect)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
        ["raw-html", () => {return "提升 infinity dimensions x" + format(player.sd.singularityPowerEffect2)}, {color: "white", fontSize: "18px", fontFamily: "monospace"}],
