            ...
            "point": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 time cube effects ^" + formatShort(player.cs.scraps.point.effect)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ...
            "code": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 mod gain ^" + formatShort(player.cs.scraps.code.effect, 3)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ...
            "dice": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 tier 1 booster dice effects ^" + formatShort(player.cs.scraps.dice.effect)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ...
            "rocket": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 rocket fuel effects ^" + formatShort(player.cs.scraps.rocket.effect, 3)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ...
            "infinity": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 base infinity point gain ^" + formatShort(player.cs.scraps.infinity.effect, 3)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ...
            "checkback": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 check back xp x" + formatShort(player.cs.scraps.checkback.effect)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
            ...
            "radioactive": {
                content: [
                    ["style-column", [
                        ...
                        ["row", [
                            ["raw-html", () => {return "提升 radiation gain x" + formatShort(player.cs.scraps.radioactive.effect)}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
