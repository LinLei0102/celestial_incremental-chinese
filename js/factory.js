addLayer("fa", {
    ...
    milestones: {
        11: {
            ...
            effectDescription() { return "提升 infinity points based on charge:<br>Currently: " + format(player.fa.milestoneEffect[0]) + "x" },
        ...
        12: {
            ...
            effectDescription() {return "提升 AD (ignoring softcap) based on charge:<br>Currently: " + format(player.fa.milestoneEffect[1]) + "x"},
            done() { return player.fa.bestCharge.gte(1000) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        13: {
            requirementDescription: "<h3>10,000 Best Charge",
            effectDescription() { return "提升 infinities based on charge:<br>Currently: " + format(player.fa.milestoneEffect[2]) + "x" },
            done() { return player.fa.bestCharge.gte(10000) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        14: {
            requirementDescription: "<h3>100,000 Best Charge",
            effectDescription() { return "提升 steel based on charge:<br>Currently: " + format(player.fa.milestoneEffect[3]) + "x" },
            done() { return player.fa.bestCharge.gte(1e5) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        15: {
            requirementDescription: "<h3>1,000,000 Best Charge",
            effectDescription() { return "提升 negative infinity points based on charge:<br>Currently: " + format(player.fa.milestoneEffect[4]) + "x" },
            done() { return player.fa.bestCharge.gte(1e6) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        16: {
            requirementDescription: "<h3>10,000,000 Best Charge",
            effectDescription() { return "提升 infinity dimensions based on charge:<br>Currently: " + format(player.fa.milestoneEffect[5]) + "x" },
            done() { return player.fa.bestCharge.gte(1e7) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        17: {
            requirementDescription: "<h3>1e9 Best Charge",
            effectDescription() { return "提升 oil based on charge: Currently:<br>" + format(player.fa.milestoneEffect[6]) + "x" },
            done() { return player.fa.bestCharge.gte(1e9) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        18: {
            requirementDescription: "<h3>1e11 Best Charge",
            effectDescription() { return "提升 anonymity based on charge:<br>Currently: " + format(player.fa.milestoneEffect[7]) + "x" },
            done() { return player.fa.bestCharge.gte(1e11) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        19: {
            requirementDescription: "<h3>1e14 Best Charge",
            effectDescription() { return "提升 galaxy dust based on charge:<br>Currently: " + format(player.fa.milestoneEffect[8]) + "x" },
            done() { return player.fa.bestCharge.gte(1e14) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        21: {
            requirementDescription: "<h3>1e50 Best Charge",
            effectDescription() { return "提升 charge based on charge:<br>Currently: " + format(player.fa.milestoneEffect[9]) + "x" },
            done() { return player.fa.bestCharge.gte(1e50) },
            style: {width: "600px", height: "70px", color: "rgba(0,0,0,0.5)", border: "5px solid rgba(0,0,0,0.5)", borderRadius: "10px", margin: "-2.5px"},
        },
        22: {
            requirementDescription: "<h3>1e100 Best Charge",
            effectDescription() { return "提升 Pre-OTF currencies based on charge:<br>Currently: " + format(player.fa.milestoneEffect[10]) + "x" },
