        ...
        Tabs: {
            ...
            "Infinitum": {
                ...
                content: [
                    ...
                    ["raw-html", () => {return hasUpgrade("tad", 121) ? "提升 matter gain x" + formatSimple(player.tad.infinitumEffect) : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => {return hasUpgrade("tad", 152) ? "提升 infinity gain x" + formatSimple(player.tad.infinitumEffect2) : ""}, {color: "black", fontSize: "20px", fontFamily: "monospace"}],
                    ["blank", "10px"],
